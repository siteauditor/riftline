...
python -m scripts.ingest status                  # also: crawl, timelines, lobbyranks, ladders, aggregate, score, reextract, winmodel, reviews, audit, groups
```
