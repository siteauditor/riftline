...
/**
 * The select, on Radix. Began as shadcn/ui's and is dressed in the site's own
 * language: a hairline control on the panel ground, gold on hover and focus
 * like every other control, and a list that is our own element rather than
 * the browser's popup, which is painted outside the document and came out
 * unreadable twice (index.css, `.control`).
 */
